...
const CookiePolicy = ({ data, location }) => {
  ...
  stored however this may downgrade or 'break' certain elements of the sites functionality.</p>
      ...
      <p>For more general information on cookies, please read <a
        href="https://www.privacypolicyonline.com/what-are-cookies/">"What Are Cookies"</a>. Information regarding cookies
  from this Cookies Policy are from <a href="https://www.generateprivacypolicy.com/">the Privacy Policy Generator</a>.
</p>
